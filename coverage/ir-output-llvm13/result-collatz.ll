...
if.then:                                          ; preds = %if.test
  %10 = load i32, i32* %int, align 4
  %11 = sdiv i32 %10, 2
  store i32 %11, i32* %int, align 4
  br label %if.cont

if.else:                                          ; preds = %if.test
  %12 = load i32, i32* %int, align 4
  %13 = mul i32 %12, 3
  %14 = add i32 %13, 1
  store i32 %14, i32* %int, align 4
  br label %if.cont

if.cont:                                          ; preds = %if.else, %if.then
  %ic.deref = load i32, i32* %k, align 4
