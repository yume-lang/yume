...
entry:                                            ; preds = %decl
  %num = alloca i32, align 4
  store i32 %arg.num, ptr %num, align 4
  br label %if.test
...
if.then4:                                         ; preds = %if.test3
  %11 = call i32 (ptr, ...) @printf(ptr @.str.2)
  br label %if.cont
